...
def main():
	...
	try:
		...
		#Need to input "2" --> Container Information
		pyautogui.typewrite('go ctmn90', interval=secs_between_keys)
		pyautogui.press('enter')
		...
		file_list = glob.glob('container.txt')
		print (Fore.GREEN + ('==============================================' ), file=stream)

		if len(file_list) == 0 :
			print (Fore.RED +'Not found any container.txt file', file=stream)
			sys.exit()
		else:
